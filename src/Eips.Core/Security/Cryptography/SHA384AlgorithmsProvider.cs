...
namespace Niacomsoft.Eips.Security.Cryptography
{
    ...
    public sealed class SHA384AlgorithmsProvider : HashAlgorithms
    {
        ...
        /// <summary> 用于初始化一个 <see cref="SHA384AlgorithmsProvider" /> 类型的对象实例。 </summary>
        public SHA384AlgorithmsProvider()
        {
