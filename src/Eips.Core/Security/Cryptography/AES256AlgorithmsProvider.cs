...
{
    /// <summary> 提供了 256 位密钥 AES 算法相关的方法。 </summary>
    /// <seealso cref="SymmetricAlgorithms" />
    public class AES256AlgorithmsProvider : SymmetricAlgorithms
    {
        ...
        protected override void InitializeSymmetricAlgorithmsProvider(ISymmetricCryptographicKey key, CipherMode mode, PaddingMode padding)
        {
            ...
            Provider.IV = Provider.Key = (key as IAESCryptographicKey).GetKeyData256();
        }

        /// <summary> 用于初始化一个 <see cref="AES256AlgorithmsProvider" /> 类型的对象实例。 </summary>
        /// <param name="key">
        /// AES 算法加密密钥。
        ...
        /// </exception>
        public AES256AlgorithmsProvider(IAESCryptographicKey key,
